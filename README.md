...
| **רב-לשוני** | עברית (ברירת מחדל) / English / Русский — בורר בסרגל הצד. הכיוון (RTL/LTR) מתחלף לפי השפה. הממשק הראשי, הכרטיסיות, הפסקים, הגרפים והאזהרות מתורגמים (טבלאות הנתונים המפורטות — בתהליך) |
