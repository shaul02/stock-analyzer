...
הנתונים נשלפים מ‑Yahoo Finance דרך הספרייה החינמית [`yfinance`](https://pypi.org/project/yfinance/), האינדיקטורים מחושבים עם ספריית הקוד הפתוח [`ta`](https://pypi.org/project/ta/), והגרפים מצוירים עם `matplotlib`.
...
| תחום | פירוט |
|------|-------|
| **קלט** | שדה סימול מניה (AAPL, TSLA…), בחירת טווח נתונים, כפתור "נתח מניה" |
...
| **גרפים** | גרף מחיר עם ממוצעים נעים ובולינגר, גרף ווליום, גרף RSI, גרף MACD |
| **סיכום טכני אוטומטי** | דירוג **Bullish / Bearish / Neutral** לפי ניקוד משוקלל של כל האיתותים, עם טבלת פירוט |
