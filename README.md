...
| **רב-לשוני מלא** | עברית (ברירת מחדל) / English / Русский — בורר בסרגל הצד. הכיוון (RTL/LTR) מתחלף לפי השפה. **כל** הממשק מתורגם: כרטיסיות, פסקים, גרפים, אזהרות, טבלאות הנתונים הפיננסיים, הסברי האיתותים ונימוקי ההמלצה. תרגומי העומק ב-`translations.py` |
| **ציור על הגרף** | סרגל כלים לציור קווים/חיצים/מלבנים ידנית · זיהוי אוטומטי של קווי **תמיכה/התנגדות** (רמות מחיר חוזרות) ו**קווי מגמה** (דרך שפלים/שיאים) — מתג "📐" בסרגל הצד |
